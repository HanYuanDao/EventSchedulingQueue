 ...
 * Desciption:
 * Author: JasonHan.
 * Creation time: 2017/12/08 10:15:00.
 * © Copyright 2013-2017, Node Supply Chain Management.
 */
public class GetPDFAddrEvent extends Event {
    /**
     ...
     * @param eventQueue
     */
    public GetPDFAddrEvent(Date doTime, Handler handler, Object data, SchedulerPriorityBlockingQueue eventQueue) {
