 ...
 * Desciption:
 * Author: JasonHan.
 * Creation time: 2017/12/08 10:30:00.
 * © Copyright 2013-2017, Node Supply Chain Management.
 */
public class GetAddrListEvent extends Event{
    /**
     ...
     * @param eventQueue
     */
    public GetAddrListEvent(Date doTime, Handler handler, Object data, SchedulerPriorityBlockingQueue eventQueue) {
